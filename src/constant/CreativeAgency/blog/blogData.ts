...
const blogData: IBlog[] = [
  {
    ...
    text: `At Asynk, we believe that creativity knows no borders. What started as a humble IT & Marketing agency has grown into a global presence, delivering innovative solutions to clients from all corners of the world.`,
    url: "/creative-agency/blog-details",
  },
  {
    id: 2,
    tag: "BRANDING",
    title: "How Asynk transform concepts into captivating visuals",
    date: "February 12, 2025",
    comments: 0,
