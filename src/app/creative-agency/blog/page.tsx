...
export const metadata: Metadata = {
  title: "Blog || Asynk - IT & Marketing Agency",
  description:
    "Stay updated with the latest insights, design trends, and development news from the Asynk team. Our blog covers topics in web design, Next.js development, digital strategy, and agency best practices.",
  keywords: [
    "Asynk blog",
